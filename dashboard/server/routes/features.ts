...
const { checkAvailIntegration } = require('../verifiers/avail-verifier');
const { checkPythIntegration } = require('../verifiers/pyth-verifier');
const { checkBlockscoutIntegration } = require('../verifiers/blockscout-verifier');
